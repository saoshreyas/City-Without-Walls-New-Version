...
def _OPERATOR_SPEC():
    ...
    return [
        ...
        ('Community Partnership (volunteers & caseworkers)', ROLE_SHELTERS, {}, 0.05,
        ...
        ('Civic Forum (reduce tensions)', ROLE_NEIGHBORHOODS, {}, 0.02,
        ...
        ('Property Value Assistance (tax incentive)', ROLE_NEIGHBORHOODS, {}, 0.08,
        ...
        # --- BUSINESS (1) ---
        ('Tax Incentives for Affordable Housing', ROLE_BUSINESS, {}, 0.12,
        ...
        ('Small Business Microgrants to Hire', ROLE_BUSINESS, {}, 0.02,
        ...
        ('Deploy Mobile Clinics', ROLE_MEDICAL, {'medical_budget': 200.0}, 0.06,
         ...
         'https://www.commonwealthfund.org/publications/case-study/2021/aug/how-medical-respite-care-program-offers-pathway-health-housing'),
        ('Medicaid & Benefits Enrollment Drive', ROLE_MEDICAL, {}, 0.05,
        ...
        ('Partner with Shelters for Onsite Clinics', ROLE_MEDICAL, {'medical_budget': 140.0}, 0.05,
         ...
         'https://pmc.ncbi.nlm.nih.gov/articles/PMC8356292'),
        ('Performance-based Funding for Treatment Outcomes', ROLE_MEDICAL, {}, 0.12,
        ...
        # --- UNIVERSITY (4) ---
        ('Research & Program Evaluation', ROLE_UNIVERSITY, {}, 0.03,
        ...
        ('Housing Innovation Lab (modular units)', ROLE_UNIVERSITY, {}, 0.10,
        ...
        ('Community-engaged Research on Displacement', ROLE_UNIVERSITY, {'university_budget': 140.0}, 0.05,
         ...
         'https://pmc.ncbi.nlm.nih.gov/articles/PMC1525292/'),
        ('Leverage Philanthropy for PSH', ROLE_UNIVERSITY, {}, 0.09,
